...
<html>
  <head>
    ...
    <title>TTCS-HL Transactions</title>
	...
	function fnOnload()
	{
		...
		accountNumber = window.opener.document.getElementById("handLoanAccountNumber").value;
		
		
			TtcsDwrUtilities.handLoanTranDetails(
				   				custId, 
				   				custName, 
				   				accountNumber,
				   				{
				   					async:false,
				   					callback:handLoanTranDetailsCallBack
				   				}	
							);
	...
	function handLoanTranDetailsCallBack(emiData)
	{
	...
	function fnEMIPayment()
	{
		...
		try
		...
		}catch(err)
  		{
			...
			TtcsDwrUtilities.handLoanEMIPayment(
				   				resultData,
				   				{
				   					async:false,
